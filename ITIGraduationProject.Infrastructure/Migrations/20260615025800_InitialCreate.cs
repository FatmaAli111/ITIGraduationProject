        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrintableAreaConfig = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LikesThreshold = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    SavesThreshold = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentPointsBalance = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableColors = table.Column<int>(type: "int", nullable: false),
                    PreviewImageURL = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    IsAvailable = table.Column<bool>(type: "bit", nullable: false),
                    StockStatus = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SupportedFabrics = table.Column<int>(type: "int", nullable: false),
                    SupportedPrintMethods = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PrinterProfiles_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    StyleTags = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    PreviewImageURL = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    IsPublic = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    LikesCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    RemixesCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    AverageRating = table.Column<decimal>(type: "decimal(3,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Templates_Users_CreatorUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FavoriteColors = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    BannedColors = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    StyleType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Interests = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DesignPreference = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ContentPreference = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    StyleMatchPercentage = table.Column<int>(type: "int", nullable: false),
                    IssuedBadges = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ViewAngle = table.Column<int>(type: "int", nullable: true),
                    PrintableZoneJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommunityInteractions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommunityInteractions_Templates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "Templates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CommunityInteractions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanvasStateJSON = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    SelectedFabric = table.Column<int>(type: "int", nullable: true),
                    SelectedPrintMethod = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Designs_Templates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "Templates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetTemplateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ModerationReports_Templates_TargetTemplateId",
                        column: x => x.TargetTemplateId,
                        principalTable: "Templates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RewardType = table.Column<int>(type: "int", nullable: false),
                    RewardValue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsClaimed = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rewards_RewardRules_RewardRuleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CurrentDesignId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AiChatSessions_Designs_CurrentDesignId",
                        column: x => x.CurrentDesignId,
            ...
            migrationBuilder.CreateTable(
                name: "DesignGraphicAssets",
                columns: table => new
                {
                    DesignsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GraphicAssetsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DesignGraphicAssets", x => new { x.DesignsId, x.GraphicAssetsId });
                    table.ForeignKey(
                        name: "FK_DesignGraphicAssets_Designs_DesignsId",
                        column: x => x.DesignsId,
                        principalTable: "Designs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DesignGraphicAssets_GraphicAssets_GraphicAssetsId",
                        column: x => x.GraphicAssetsId,
                        principalTable: "GraphicAssets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_Rewards_RewardId",
                        column: x => x.RewardId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PriceBreakdown = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    SnapshotImageURL = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItems_PrinterProfiles_PrinterProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiChatSessions_CurrentDesignId",
                table: "AiChatSessions",
                column: "CurrentDesignId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommunityInteractions_TemplateId",
                table: "CommunityInteractions",
                column: "TemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_CommunityInteractions_UserId",
                table: "CommunityInteractions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DesignGraphicAssets_GraphicAssetsId",
                table: "DesignGraphicAssets",
                column: "GraphicAssetsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModerationReports_TargetTemplateId",
                table: "ModerationReports",
                column: "TargetTemplateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_PrinterProfileId",
                table: "OrderItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrinterProfiles_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Templates_CreatorUserId",
                table: "Templates",
